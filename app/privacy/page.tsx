    ...
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <section className="mt-10">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5">
          ...
          {/* 2026-08-09 감사: 약관에는 "결제와 파일 발송은 래피드(Latpeed)가 처리한다"고 적혀 있는데
              이 목록에는 없었다. 결제·전송을 대행하면 수탁자다 — 약관과 방침이 갈리면 안 된다. */}
          <li className="leading-8 text-muted">
            <strong className="font-semibold text-ink">래피드(Latpeed)</strong> — 유료 콘텐츠의 결제 대행과
            파일 전송 업무 위탁. 상품을 구매하시면 구매자 이메일 주소와 결제 정보가 래피드에서 처리되고,
            구매하신 파일도 래피드를 통해 전달됩니다. 결제 수단 정보는 이 사이트가 보관하지 않습니다.
            구매하지 않으시면 이 위탁은 발생하지 않습니다.
          </li>
        </ul>
        <p className="mt-3 leading-8 text-muted">

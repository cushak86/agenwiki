...
export const metadata = buildMetadata({
  ...
  description:
    "프로젝트 정보와 작업 규칙을 클릭으로 고르면 CLAUDE.md·AGENTS.md·.cursor/rules(.mdc) 파일이 완성됩니다. Claude Code·Codex·Cursor용. 무료, 로그인 없음.",
    ...
    <div className="mx-auto max-w-6xl px-4 py-12">
      <div className="max-w-3xl">
        ...
        <p className="mt-4 leading-8 text-muted">
          AI 코딩 도구는 저장소에 둔 설정 파일을 읽고 그 규칙대로 일합니다. 아래에서 프로젝트 정보와 규칙을 고르면
          Claude Code용 CLAUDE.md, 여러 도구가 함께 읽는 AGENTS.md, Cursor용 .cursor/rules/*.mdc — 세 형식 모두로
          만들어 드립니다. 두는 위치는 형식마다 다르며, 각 형식을 고르면 어디에 둘지 안내합니다.
        </p>
      </div>

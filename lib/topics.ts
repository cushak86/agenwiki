export const TOPICS = [
  ...
  { slug: "data-analysis-prompts", name: "데이터 분석 프롬프트", description: "SQL 작성·결과 해석·수식 생성 등 데이터 실무 프롬프트" },
  { slug: "planning-prompts", name: "기획·전략 프롬프트", description: "PRD 초안·경쟁 분석·인터뷰 설계 등 기획 실무 프롬프트" },
  { slug: "marketing-prompts", name: "마케팅 프롬프트", description: "카피 A/B·SEO 개요·페르소나 정의 등 마케팅 실무 프롬프트" },
  { slug: "developer-prompts", name: "개발 프롬프트", description: "테스트 케이스·에러 로그 분석·PR 설명 등 개발 실무 프롬프트" },
  { slug: "learning-prompts", name: "학습 프롬프트", description: "오답 노트·개념 비교·학습 계획 등 공부에 쓰는 프롬프트" },

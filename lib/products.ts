...
export const products: Product[] = [
  ...
  },
  {
    ...
    // PDF 배포 중단(2026-08-08) → 파일 삭제(2026-08-09). 구판에 폐기된 성과 보증이 실려 있다.
    // 2026-08-08 에는 링크만 끊고 파일을 남겼는데, 감사 결과 그 파일이 계속 200 으로 내려받아지고
    // 있었다(415KB). 경로가 같은 페이지 주석에 적혀 있었으니 막은 것이 아니었다.
    // 경위·복구 절차·래피드 미조치 건: docs/rankup-랜딩-운영메모.md
    description:
